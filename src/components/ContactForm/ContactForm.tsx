...
const ContactForm: React.FC<ContactFormProps> = (props) => {
    ...
    const sendEmail = (values: {
        ...
        emailjs.send('service_iior77p', 'template_utx6ldx', values, 'qjUi92l0rApn_A14S').then(
            (result) => {
        ...
        <>
            {errorMessage && (
                <div className={classes.message}>
                    ...
                    <h3 className={classes.errorHeading}>An error occurred, Please try again.</h3>
                </div>
            )}
            {thankYouMessage && (
                <div className={classes.message}>
                            ...
                            <Row className='mb-3'>
                                <Form.Group className='mb-3'>
                                    <Form.Check
                                        ...
                                        type='checkbox'
                                        name='terms'
                                        label='"I agree to the processing of submitted personal data. My data will not be made available to third parties or published without my consent.'
                                        onChange={handleChange}
